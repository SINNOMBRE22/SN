...
if [[ $- == *i* ]] && [[ -z "${SN_WELCOME_SHOWN:-}" ]]; then
  ...
  # Intentar usar herramientas disponibles
  if command -v figlet &>/dev/null; then
    figlet "SinNombre" | lolcat
  ...
  echo
  echo "[menu]: Acceso completo."
  echo "[sn]: Menú interactivo"
fi
EOF
...
# Otros sectores permanecen igual
