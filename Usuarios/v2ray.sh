...
# =====================================================
# GESTIÓN DE USUARIOS V2RAY - SINNOMBRE
# =====================================================
...
respaldo(){
        ...
        case $opcion in
                ...
                msg -bar
                read foo;;
                2)[[ ! -e "/root/User-V2ray.txt" ]] && msg -verm2 " no hay copia de usuarios!" && sleep 3 && return
                var=$(cat /root/User-V2ray.txt)
                [[  -z "$var" ]] && msg -verm2 " copia de usuarios vacio!" && sleep 3 && return
                mv $config $temp
